...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    @Query(value = "select distinct u.id, u.username, u.password, u.lastname, u.firstname, u.sex, u.date_of_birth, u.address, u.nationality, u.phone, u.email, u.created_date from " +
